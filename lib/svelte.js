var svelte = (function (exports) {
	...
	function isRegExpIdentifierStart(ch) {
	  return isIdentifierStart$2(ch, true) || ch === 0x24 /* $ */ || ch === 0x5F /* _ */
	}
	...
	pp$8.regexp_eatHexDigits = function(state) {
	  ...
	  var ch = 0;
	  state.lastIntValue = 0;
	  while (isHexDigit$3(ch = state.current())) {
	    state.lastIntValue = 16 * state.lastIntValue + hexToInt(ch);
	    state.advance();
	  }
	  return state.pos !== start
	};
	function isHexDigit$3(ch) {
	  return (
	    (ch >= 0x30 /* 0 */ && ch <= 0x39 /* 9 */) ||
	    (ch >= 0x41 /* A */ && ch <= 0x46 /* F */) ||
	    (ch >= 0x61 /* a */ && ch <= 0x66 /* f */)
	...
	pp$9.readNumber = function(startsWithDot) {
	  ...
	  if (!octal && !startsWithDot && this.options.ecmaVersion >= 11 && next === 110) {
	    ...
	    ++this.pos;
	    if (isIdentifierStart$2(this.fullCharCodeAtPos())) { this.raise(this.pos, "Identifier directly after number"); }
	...
	pp$9.readWord1 = function() {
	  ...
	  while (this.pos < this.input.length) {
	    ...
	    if (isIdentifierChar(ch, astral)) {
	      ...
	      if (!(first ? isIdentifierStart$2 : isIdentifierChar)(esc, astral))
	...
	const parse$1 = (source) => parse$2(source, {
		sourceType: 'module',
		ecmaVersion: 12,
		locations: true
	});
	...
	var NAME$3 = Object.keys(TYPE$D).reduce(function(result, key) {
	    result[TYPE$D[key]] = key;
	    return result;
	}, {});
	...
	function isName$2(code) {
	    return isNameStart(code) || isDigit$3(code) || code === 0x002D;
	}
	...
	function isNumberStart$1(first, second, third) {
	    ...
	    if (first === 0x002B || first === 0x002D) {
	        ...
	        return second === 0x002E && isDigit$3(third) ? 3 : 0;
	    }

	    // U+002E FULL STOP (.)
	    if (first === 0x002E) {
	        // If the second code point is a digit, return true. Otherwise, return false.
	        return isDigit$3(second) ? 2 : 0;
	    }
	...
	for (var i$1 = 0; i$1 < CATEGORY.length; i$1++) {
	    switch (true) {
	        case isWhiteSpace$2(i$1):
	            CATEGORY[i$1] = charCodeCategory$1.WhiteSpace;
	            break;

	        case isDigit$3(i$1):
	            CATEGORY[i$1] = charCodeCategory$1.Digit;
	            break;

	        case isNameStart(i$1):
	            CATEGORY[i$1] = charCodeCategory$1.NameStart;
	            break;

	        case isNonPrintable(i$1):
	            CATEGORY[i$1] = charCodeCategory$1.NonPrintable;
	            break;

	        default:
	            CATEGORY[i$1] = i$1 || charCodeCategory$1.Eof;
	    }
	}
	...
	charCodeDefinitions.isDigit;
	charCodeDefinitions.isHexDigit;
	charCodeDefinitions.isUppercaseLetter;
	charCodeDefinitions.isLowercaseLetter;
	charCodeDefinitions.isLetter;
	charCodeDefinitions.isNonAscii;
	charCodeDefinitions.isNameStart;
	charCodeDefinitions.isName;
	charCodeDefinitions.isNonPrintable;
	charCodeDefinitions.isNewline;
	charCodeDefinitions.isWhiteSpace;
	charCodeDefinitions.isValidEscape;
	charCodeDefinitions.isIdentifierStart;
	charCodeDefinitions.isNumberStart;
	charCodeDefinitions.isBOM;
	charCodeDefinitions.charCodeCategory;

	var isDigit$2 = charCodeDefinitions.isDigit;
	...
	function cmpChar$3(testStr, offset, referenceCode) {
	...
	function consumeNumber$4(source, offset) {
	    var code = source.charCodeAt(offset);
	    ...
	    if (code === 0x002E && isDigit$2(source.charCodeAt(offset + 1))) {
	        // 4.1 Consume them.
	    ...
	    if (cmpChar$3(source, offset, 101 /* e */)) {
	        var sign = 0;
	        code = source.charCodeAt(offset + 1);
	...
	utils.consumeEscaped;
	utils.consumeName;
	utils.consumeNumber;
	utils.consumeBadUrlRemnants;
	utils.cmpChar;
	utils.cmpStr;
	utils.getNewlineLength;
	utils.findWhiteSpaceStart;
	utils.findWhiteSpaceEnd;

	var TYPE$C = _const.TYPE;
	...
	var EOF = TYPE$C.EOF;
	var WHITESPACE$b = TYPE$C.WhiteSpace;
	var COMMENT$9 = TYPE$C.Comment;
	...
	TokenStream.prototype = {
	    ...
	    isDelim: function(code, offset) {
	        if (offset) {
	            return (
	                this.lookupType(offset) === TYPE$C.Delim &&
	                this.source.charCodeAt(this.lookupOffset(offset)) === code
	            );
	        }

	        return (
	            this.tokenType === TYPE$C.Delim &&
	    ...
	    skipWS: function() {
	        for (var i = this.tokenIndex, skipTokenCount = 0; i < this.tokenCount; i++, skipTokenCount++) {
	            if ((this.offsetAndType[i] >> TYPE_SHIFT$1) !== WHITESPACE$b) {
	                break;
	            }
	        }
	    ...
	    skipSC: function() {
	        while (this.tokenType === WHITESPACE$b || this.tokenType === COMMENT$9) {
	            this.next();
	        }
	    },
	...
	function tokenize(source, stream) {
	    ...
	    function consumeNumericToken() {
	        ...
	        offset = consumeNumber$3(source, offset);
	    ...
	    while (offset < sourceLength) {
	        ...
	        switch (charCodeCategory(code)) {
	            ...
	            case 0x005D:
	                // Return a <]-token>.
	                type = TYPE$B.RightSquareBracket;
	                offset++;
	                break;
	        ...
	        switch (type) {
	            ...
	            case TYPE$B.LeftParenthesis:
	            case TYPE$B.Function:
	                balance[tokenCount] = balanceStart;
	                balanceCloseType = TYPE$B.RightParenthesis;
	                balanceStart = (balanceCloseType << TYPE_SHIFT) | tokenCount;
	                break;

	            case TYPE$B.LeftSquareBracket:
	                balance[tokenCount] = balanceStart;
	                balanceCloseType = TYPE$B.RightSquareBracket;
	                balanceStart = (balanceCloseType << TYPE_SHIFT) | tokenCount;
	                break;

	            case TYPE$B.LeftCurlyBracket:
	                balance[tokenCount] = balanceStart;
	                balanceCloseType = TYPE$B.RightCurlyBracket;
	                balanceStart = (balanceCloseType << TYPE_SHIFT) | tokenCount;
	                break;
	        }
	    ...
	    // finalize buffers
	    offsetAndType[tokenCount] = (TYPE$B.EOF << TYPE_SHIFT) | offset; // <EOF-token>
	    balance[tokenCount] = sourceLength;
	...
	var { findWhiteSpaceStart, cmpStr: cmpStr$2 } = utils;
	...
	var cmpStr$1 = tokenizer.cmpStr;
	var TYPE$y = tokenizer.TYPE;

	var IDENT$f = TYPE$y.Ident;
	var STRING$3 = TYPE$y.String;
	var NUMBER$6 = TYPE$y.Number;
	var FUNCTION$5 = TYPE$y.Function;
	var URL$3 = TYPE$y.Url;
	var HASH$4 = TYPE$y.Hash;
	var DIMENSION$5 = TYPE$y.Dimension;
	var PERCENTAGE$2 = TYPE$y.Percentage;
	var LEFTPARENTHESIS$5 = TYPE$y.LeftParenthesis;
	var LEFTSQUAREBRACKET$3 = TYPE$y.LeftSquareBracket;
	var COMMA$3 = TYPE$y.Comma;
	var DELIM$4 = TYPE$y.Delim;
	...
	var _default = function defaultRecognizer(context) {
	    switch (this.scanner.tokenType) {
	        ...
	        case FUNCTION$5:
	            return cmpStr$1(this.scanner.source, this.scanner.tokenStart, this.scanner.tokenEnd, 'url(')
	                ? this.Url()
	        ...
	        case IDENT$f:
	            ...
	            if (cmpChar$2(this.scanner.source, this.scanner.tokenStart, U$1) &&
	                cmpChar$2(this.scanner.source, this.scanner.tokenStart + 1, PLUSSIGN$5)) {
	...
	atrulePrelude.getNode;

	var TYPE$x = tokenizer.TYPE;

	var DELIM$3 = TYPE$x.Delim;
	var IDENT$e = TYPE$x.Ident;
	var DIMENSION$4 = TYPE$x.Dimension;
	var PERCENTAGE$1 = TYPE$x.Percentage;
	var NUMBER$5 = TYPE$x.Number;
	var HASH$3 = TYPE$x.Hash;
	var COLON$6 = TYPE$x.Colon;
	var LEFTSQUAREBRACKET$2 = TYPE$x.LeftSquareBracket;
	...
	function getNode(context) {
	    switch (this.scanner.tokenType) {
	        ...
	        case COLON$6:
	            if (this.scanner.lookupType(1) === COLON$6) {
	...
	var WhiteSpace$1 = TYPE$w.WhiteSpace;
	var Semicolon = TYPE$w.Semicolon;
	var LeftCurlyBracket = TYPE$w.LeftCurlyBracket;
	var Delim = TYPE$w.Delim;
	...
	var COMMA$2 = TYPE$v.Comma;
	var WHITESPACE$8 = TYPE$v.WhiteSpace;
	    ...
	    if (this.scanner.tokenType === COMMA$2) {
	        ...
	        if (value.type === 'Value' && value.children.isEmpty()) {
	            for (let offset = startIndex - this.scanner.tokenIndex; offset <= 0; offset++) {
	                if (this.scanner.lookupType(offset) === WHITESPACE$8) {
	...
	var STRING$2 = TYPE$u.String;
	var IDENT$d = TYPE$u.Ident;
	var URL$2 = TYPE$u.Url;
	var FUNCTION$4 = TYPE$u.Function;
	var LEFTPARENTHESIS$4 = TYPE$u.LeftParenthesis;
	...
	var _import = {
	    parse: {
	        prelude: function() {
	            ...
	            if (this.lookupNonWSType(0) === IDENT$d ||
	                this.lookupNonWSType(0) === LEFTPARENTHESIS$4) {
	...
	var COMMENT$6 = TYPE$t.Comment;
	var IDENT$c = TYPE$t.Ident;
	var FUNCTION$3 = TYPE$t.Function;
	var COLON$5 = TYPE$t.Colon;
	var LEFTPARENTHESIS$3 = TYPE$t.LeftParenthesis;
	...
	function parentheses() {
	    ...
	    if (this.scanner.tokenType === IDENT$c &&
	        this.lookupNonWSType(1) === COLON$5) {
	        return this.createSingleNodeList(
	            this.Declaration()
	        );
	    }
	...
	var isDigit$1 = tokenizer.isDigit;
	var TYPE$s = tokenizer.TYPE;

	var WHITESPACE$6 = TYPE$s.WhiteSpace;
	var COMMENT$5 = TYPE$s.Comment;
	var IDENT$b = TYPE$s.Ident;
	var NUMBER$4 = TYPE$s.Number;
	var DIMENSION$3 = TYPE$s.Dimension;
	...
	function checkInteger(offset, disallowSign) {
	    ...
	    if (code === PLUSSIGN$3 || code === HYPHENMINUS$2) {
	        if (disallowSign) {
	...
	function expectCharCode(offset, code) {
	    if (!cmpChar$1(this.scanner.source, this.scanner.tokenStart + offset, code)) {
	        var msg = '';
	...
	function consumeB() {
	    ...
	    while (type === WHITESPACE$6 || type === COMMENT$5) {
	    ...
	    if (type !== NUMBER$4) {
	        if (this.scanner.isDelim(PLUSSIGN$3, offset) ||
	            ...
	            sign = this.scanner.isDelim(PLUSSIGN$3, offset) ? PLUSSIGN$3 : HYPHENMINUS$2;
	    ...
	    if (sign === 0) {
	        ...
	        if (type !== PLUSSIGN$3 && type !== HYPHENMINUS$2) {
	            this.error('Number sign is expected');
	        }
	    }

	    checkTokenIsInteger.call(this, sign !== 0);
	    return sign === HYPHENMINUS$2 ? '-' + this.consume(NUMBER$4) : this.consume(NUMBER$4);
	}
	...
	var AnPlusB = {
	    ...
	    parse: function() {
	        ...
	        else if (this.scanner.tokenType === IDENT$b && cmpChar$1(this.scanner.source, this.scanner.tokenStart, HYPHENMINUS$2)) {
	            a = '-1';
	        ...
	        // '+'? n- <signless-integer>
	        // '+'? <ndashdigit-ident>
	        else if (this.scanner.tokenType === IDENT$b || (this.scanner.isDelim(PLUSSIGN$3) && this.scanner.lookupType(1) === IDENT$b)) {
	            var sign = 0;
	            a = '1';
	        ...
	        else if (this.scanner.tokenType === DIMENSION$3) {
	            var code = this.scanner.source.charCodeAt(this.scanner.tokenStart);
	            var sign = code === PLUSSIGN$3 || code === HYPHENMINUS$2;
	...
	var ATKEYWORD$2 = TYPE$r.AtKeyword;
	var SEMICOLON$4 = TYPE$r.Semicolon;
	var LEFTCURLYBRACKET$3 = TYPE$r.LeftCurlyBracket;
	var RIGHTCURLYBRACKET$1 = TYPE$r.RightCurlyBracket;

	function consumeRaw$4(startToken) {
	    return this.Raw(startToken, rawMode$4.leftCurlyBracketOrSemicolon, true);
	}
	    ...
	    parse: function() {
	        ...
	        if (this.scanner.eof === false &&
	            ...
	            if (this.parseAtrulePrelude) {
	                prelude = this.parseWithFallback(this.AtrulePrelude.bind(this, name), consumeRaw$4);
	                ...
	                prelude = consumeRaw$4.call(this, this.scanner.tokenIndex);
	            }
	...
	Atrule$1.parse;
	Atrule$1.generate;
	Atrule$1.walkContext;

	var TYPE$q = tokenizer.TYPE;

	var SEMICOLON$3 = TYPE$q.Semicolon;
	var LEFTCURLYBRACKET$2 = TYPE$q.LeftCurlyBracket;
	...
	AtrulePrelude.name;
	AtrulePrelude.structure;
	AtrulePrelude.parse;
	AtrulePrelude.generate;
	AtrulePrelude.walkContext;

	var TYPE$p = tokenizer.TYPE;

	var IDENT$a = TYPE$p.Ident;
	var STRING$1 = TYPE$p.String;
	var COLON$4 = TYPE$p.Colon;
	var LEFTSQUAREBRACKET$1 = TYPE$p.LeftSquareBracket;
	var RIGHTSQUAREBRACKET$1 = TYPE$p.RightSquareBracket;
	...
	function getAttributeName() {
	    ...
	    if (this.scanner.isDelim(ASTERISK$3)) {
	        expectIdent = true;
	        checkColon = false;
	        this.scanner.next();
	...
	var AttributeSelector = {
	    ...
	    parse: function() {
	        ...
	        if (this.scanner.tokenType !== RIGHTSQUAREBRACKET$1) {
	            // avoid case `[name i]`
	            if (this.scanner.tokenType !== IDENT$a) {
	                matcher = getOperator.call(this);

	                this.scanner.skipSC();

	                value = this.scanner.tokenType === STRING$1
	                    ? this.String()
	                    : this.Identifier();
	...
	AttributeSelector.structure;
	AttributeSelector.parse;
	AttributeSelector.generate;

	var TYPE$o = tokenizer.TYPE;
	var rawMode$3 = Raw.mode;

	var WHITESPACE$5 = TYPE$o.WhiteSpace;
	var COMMENT$4 = TYPE$o.Comment;
	var SEMICOLON$2 = TYPE$o.Semicolon;
	var ATKEYWORD$1 = TYPE$o.AtKeyword;
	var LEFTCURLYBRACKET$1 = TYPE$o.LeftCurlyBracket;
	var RIGHTCURLYBRACKET = TYPE$o.RightCurlyBracket;
	    ...
	    parse: function(isDeclaration) {
	        ...
	        while (!this.scanner.eof) {
	            switch (this.scanner.tokenType) {
	                ...
	                case ATKEYWORD$1:
	                    children.push(this.parseWithFallback(this.Atrule, consumeRaw$3));
	                    break;
	...
	var LEFTSQUAREBRACKET = TYPE$n.LeftSquareBracket;
	var RIGHTSQUAREBRACKET = TYPE$n.RightSquareBracket;
	...
	ClassSelector.name;
	ClassSelector.structure;
	ClassSelector.parse;
	ClassSelector.generate;

	var TYPE$l = tokenizer.TYPE;

	var IDENT$8 = TYPE$l.Ident;
	...
	var HYPHENMINUS$1 = 45; // '-'.charCodeAt()

	function isCustomProperty$1(str, offset) {
	    offset = offset || 0;

	    return str.length - offset >= 2 &&
	           str.charCodeAt(offset) === HYPHENMINUS$1 &&
	           str.charCodeAt(offset + 1) === HYPHENMINUS$1;
	}
	...
	function getVendorPrefix(str, offset) {
	    ...
	    if (str.length - offset >= 3) {
	        ...
	        if (str.charCodeAt(offset) === HYPHENMINUS$1 &&
	            str.charCodeAt(offset + 1) !== HYPHENMINUS$1) {
	...
	function getPropertyDescriptor(property) {
	    if (hasOwnProperty.call(properties$1, property)) {
	    ...
	    if (!custom) {
	        name = name.toLowerCase();
	        if (hasOwnProperty.call(properties$1, name)) {
	...
	var HASH$2 = TYPE$j.Hash;
	var COLON$3 = TYPE$j.Colon;
	var SEMICOLON$1 = TYPE$j.Semicolon;
	var DELIM$2 = TYPE$j.Delim;
	var WHITESPACE$4 = TYPE$j.WhiteSpace;
	    ...
	    parse: function() {
	        ...
	        if (customProperty && value.type === 'Value' && value.children.isEmpty()) {
	            for (let offset = valueStart - this.scanner.tokenIndex; offset <= 0; offset++) {
	                if (this.scanner.lookupType(offset) === WHITESPACE$4) {
	                    value.children.appendData({
	                        type: 'WhiteSpace',
	                        loc: null,
	                        value: ' '
	...
	function readProperty() {
	    ...
	    if (this.scanner.tokenType === DELIM$2) {
	        switch (this.scanner.source.charCodeAt(this.scanner.tokenStart)) {
	            ...
	            case SOLIDUS$1:
	                this.scanner.next();
	                if (this.scanner.isDelim(SOLIDUS$1)) {
	                    this.scanner.next();
	                }
	                break;
	        }
	    ...
	    if (this.scanner.tokenType === HASH$2) {
	        this.eat(HASH$2);
	    } else {
	        this.eat(IDENT$7);
	    }
	...
	Declaration$1.name;
	Declaration$1.structure;
	Declaration$1.parse;
	Declaration$1.generate;
	Declaration$1.walkContext;

	var TYPE$i = tokenizer.TYPE;
	var rawMode$1 = Raw.mode;

	var WHITESPACE$3 = TYPE$i.WhiteSpace;
	var COMMENT$2 = TYPE$i.Comment;
	var SEMICOLON = TYPE$i.Semicolon;
	...
	DeclarationList.name;
	DeclarationList.structure;
	DeclarationList.parse;
	DeclarationList.generate;

	var consumeNumber$2 = utils.consumeNumber;
	var TYPE$h = tokenizer.TYPE;

	var DIMENSION$2 = TYPE$h.Dimension;
	...
	var RIGHTPARENTHESIS$5 = TYPE$g.RightParenthesis;
	...
	_Function.parse;
	_Function.generate;
	_Function.walkContext;

	var TYPE$f = tokenizer.TYPE;

	var HASH$1 = TYPE$f.Hash;
	...
	IdSelector.name;
	IdSelector.structure;
	IdSelector.parse;
	IdSelector.generate;

	var TYPE$c = tokenizer.TYPE;

	var IDENT$5 = TYPE$c.Ident;
	var NUMBER$3 = TYPE$c.Number;
	var DIMENSION$1 = TYPE$c.Dimension;
	var LEFTPARENTHESIS$2 = TYPE$c.LeftParenthesis;
	var RIGHTPARENTHESIS$4 = TYPE$c.RightParenthesis;
	var COLON$2 = TYPE$c.Colon;
	var DELIM$1 = TYPE$c.Delim;
	...
	MediaFeature.name;
	MediaFeature.structure;
	MediaFeature.parse;
	MediaFeature.generate;

	var TYPE$b = tokenizer.TYPE;

	var WHITESPACE$2 = TYPE$b.WhiteSpace;
	var COMMENT$1 = TYPE$b.Comment;
	var IDENT$4 = TYPE$b.Ident;
	var LEFTPARENTHESIS$1 = TYPE$b.LeftParenthesis;
	...
	MediaQueryList.name;
	MediaQueryList.structure;
	MediaQueryList.parse;
	MediaQueryList.generate;
	...
	var NUMBER$2 = tokenizer.TYPE.Number;
	...
	var LEFTPARENTHESIS = TYPE$a.LeftParenthesis;
	var RIGHTPARENTHESIS$3 = TYPE$a.RightParenthesis;
	...
	var PERCENTAGE = TYPE$9.Percentage;
	...
	var IDENT$3 = TYPE$8.Ident;
	var FUNCTION$2 = TYPE$8.Function;
	var COLON$1 = TYPE$8.Colon;
	var RIGHTPARENTHESIS$2 = TYPE$8.RightParenthesis;
	...
	PseudoClassSelector.name;
	PseudoClassSelector.structure;
	PseudoClassSelector.parse;
	PseudoClassSelector.generate;
	PseudoClassSelector.walkContext;

	var TYPE$7 = tokenizer.TYPE;

	var IDENT$2 = TYPE$7.Ident;
	var FUNCTION$1 = TYPE$7.Function;
	var COLON = TYPE$7.Colon;
	var RIGHTPARENTHESIS$1 = TYPE$7.RightParenthesis;
	...
	PseudoElementSelector.name;
	PseudoElementSelector.structure;
	PseudoElementSelector.parse;
	PseudoElementSelector.generate;
	PseudoElementSelector.walkContext;

	var isDigit = tokenizer.isDigit;
	var TYPE$6 = tokenizer.TYPE;

	var NUMBER$1 = TYPE$6.Number;
	var DELIM = TYPE$6.Delim;
	...
	function consumeNumber() {
	    ...
	    var value = this.consume(NUMBER$1);
	...
	var LEFTCURLYBRACKET = TYPE$5.LeftCurlyBracket;
	...
	SelectorList.name;
	SelectorList.structure;
	SelectorList.parse;
	SelectorList.generate;
	SelectorList.walkContext;

	var STRING = tokenizer.TYPE.String;
	...
	var COMMENT = TYPE$3.Comment;
	var ATKEYWORD = TYPE$3.AtKeyword;
	var CDO = TYPE$3.CDO;
	var CDC = TYPE$3.CDC;
	...
	StyleSheet.parse;
	StyleSheet.generate;
	StyleSheet.walkContext;

	var TYPE$2 = tokenizer.TYPE;

	var IDENT$1 = TYPE$2.Ident;
	var ASTERISK = 0x002A;     // U+002A ASTERISK (*)
	var VERTICALLINE = 0x007C; // U+007C VERTICAL LINE (|)

	function eatIdentifierOrAsterisk() {
	    if (this.scanner.tokenType !== IDENT$1 &&
	...
	TypeSelector.name;
	TypeSelector.structure;
	TypeSelector.parse;
	TypeSelector.generate;

	var isHexDigit = tokenizer.isHexDigit;
	var cmpChar = tokenizer.cmpChar;
	var TYPE$1 = tokenizer.TYPE;
	var NAME = tokenizer.NAME;

	var IDENT = TYPE$1.Ident;
	var NUMBER = TYPE$1.Number;
	var DIMENSION = TYPE$1.Dimension;
	...
	UnicodeRange.parse;
	UnicodeRange.generate;

	var isWhiteSpace = tokenizer.isWhiteSpace;
	...
	parser$1.parseContext;
	parser$1.scope;
	parser$1.atrule;
	parser$1.pseudo;
	parser$1.node;

	var parser = create(parser$1);

	function read_style(parser$1, start, attributes) {
		const content_start = parser$1.index;
		const styles = parser$1.read_until(/<\/style>/);
		const content_end = parser$1.index;
	...
	function is_valid(str) {
		...
		while (i < str.length) {
			...
			if (!(i === 0 ? isIdentifierStart$2 : isIdentifierChar)(code, true)) return false;
	...
	function read_context(
		...
		if (isIdentifierStart$2(code, true)) {
			return {
				type: 'Identifier',
				...
				if (block.type !== 'IfBlock') {
					parser.error({
						...
						message: parser.stack.some(block => block.type === 'IfBlock')
							? `Expected to close ${to_string$1(block)} before seeing {:else if ...} block`
				...
				if (block.type !== 'IfBlock' && block.type !== 'EachBlock') {
					parser.error({
						...
						message: parser.stack.some(block => block.type === 'IfBlock' || block.type === 'EachBlock')
							? `Expected to close ${to_string$1(block)} before seeing {:else} block`
				...
				if (block.type !== 'PendingBlock') {
					parser.error({
						...
						message: parser.stack.some(block => block.type === 'PendingBlock')
							? `Expected to close ${to_string$1(block)} before seeing {:then} block`
				...
				if (block.type !== 'ThenBlock' && block.type !== 'PendingBlock') {
					parser.error({
						...
						message: parser.stack.some(block => block.type === 'ThenBlock' || block.type === 'PendingBlock')
							? `Expected to close ${to_string$1(block)} before seeing {:catch} block`
	...
	class Parser {
		...
		read_identifier(allow_reserved = false) {
			...
			if (!isIdentifierStart$2(code, true)) return null;
	...
	class Block$1 {
		...
		constructor(options) {Block$1.prototype.__init.call(this);Block$1.prototype.__init2.call(this);Block$1.prototype.__init3.call(this);Block$1.prototype.__init4.call(this);Block$1.prototype.__init5.call(this);
	...
	const namespaces = { foreign, html, mathml, svg: svg$1, xlink, xml, xmlns };
	...
	class MustacheTagWrapper extends Tag$2 {
	...
	class RawMustacheTagWrapper extends Tag$2 {
			...
			while (i--) {
				...
				if (child.type === 'Text') {
					...
					if (this.nodes.length === 0) {
						const should_trim = (
							next_sibling ? (next_sibling.node.type === 'Text' && /^\s/.test(next_sibling.node.data) && trimmable_at$1(child, next_sibling)) : !child.has_ancestor('EachBlock')
						);
	...
	class Renderer$1 {
		...
		constructor(component, options) {Renderer$1.prototype.__init.call(this);Renderer$1.prototype.__init2.call(this);Renderer$1.prototype.__init3.call(this);Renderer$1.prototype.__init4.call(this);Renderer$1.prototype.__init5.call(this);Renderer$1.prototype.__init6.call(this);Renderer$1.prototype.__init7.call(this);
	...
	class EachBlock extends AbstractBlock {
		...
		constructor(component, parent, scope, info) {
			super(component, parent, scope, info);EachBlock.prototype.__init.call(this);EachBlock.prototype.__init2.call(this);
			this.expression = new Expression(component, this, scope, info.expression);
	...
	class InlineComponent extends Node {
		...
		__init4() {this.lets = [];}
		__init5() {this.css_custom_properties = [];}



		constructor(component, parent, scope, info) {
			super(component, parent, scope, info);InlineComponent.prototype.__init.call(this);InlineComponent.prototype.__init2.call(this);InlineComponent.prototype.__init3.call(this);InlineComponent.prototype.__init4.call(this);InlineComponent.prototype.__init5.call(this);
	...
	class Slot extends Element {
		...
		constructor(component, parent, scope, info) {
			super(component, parent, scope, info);Slot.prototype.__init.call(this);
	...
	function get_constructor(type) {
		switch (type) {
			...
			case 'SlotTemplate': return SlotTemplate$1;
	...
	class SlotTemplate$1 extends Node {
		...
		constructor(
			...
			super(component, parent, scope, info);SlotTemplate$1.prototype.__init.call(this);SlotTemplate$1.prototype.__init2.call(this);
	...
	function SlotTemplate(node, renderer, options
		...
		const children = remove_whitespace_children(node instanceof SlotTemplate$1 ? node.children : [node], node.next);
	...
	class Renderer {
		...
		constructor({ name }) {Renderer.prototype.__init.call(this);Renderer.prototype.__init2.call(this);Renderer.prototype.__init3.call(this);
			this.name = name;
			this.push();
		}
	 ...
	 = [];}
		...
		generate(result) {
			...
			if (result) {
				...
				const banner = `${this.file ? `${this.file} ` : ''}generated by Svelte v${'3.38.2'}`;
